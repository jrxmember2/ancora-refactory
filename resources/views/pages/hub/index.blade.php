...
<div class="fixed bottom-2 right-2 z-[99999] inline-flex rounded-full border border-gray-200 bg-white/95 px-3 py-2 text-[11px] font-medium text-gray-600 shadow-theme-lg backdrop-blur dark:border-gray-800 dark:bg-gray-900/95 dark:text-gray-300">
