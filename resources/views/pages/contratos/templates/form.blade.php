        ...
        <div class="space-y-6">
            <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-theme-xs dark:border-gray-800 dark:bg-white/[0.03]">
                ...
                <div class="mt-5 grid grid-cols-1 gap-4 md:grid-cols-2">
                    ...
                    <div class="md:col-span-2"><label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">Titulo padrao do contrato</label><input name="default_contract_title" value="{{ old('default_contract_title', $item?->default_contract_title ?: $item?->name) }}" class="{{ $inputClass }}" placeholder="Ex.: Contrato de assessoria juridica condominial"></div>
