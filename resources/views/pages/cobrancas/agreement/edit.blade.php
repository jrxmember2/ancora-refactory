...
@section('content')
<x-ancora.section-header :title="'Termo de acordo · OS '.$case->os_number" subtitle="Revise o rascunho automático, ajuste o texto quando necessário e gere a versão A4 para PDF/print.">
    <div class="flex flex-wrap gap-3">
        ...
        <a href="{{ route('cobrancas.agreement.pdf', $case) }}" target="_blank" class="rounded-xl bg-brand-500 px-4 py-3 text-sm font-medium text-white">PDF / Print</a>
    </div>
...
<div class="grid grid-cols-1 gap-6 xl:grid-cols-[minmax(0,1fr)_360px]">
    <form method="post" action="{{ route('cobrancas.agreement.save', $case) }}" class="space-y-6">
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-theme-xs dark:border-gray-800 dark:bg-white/[0.03]">
            ...
            <div class="mt-5">
                ...
                <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">Você pode alterar cláusulas, nomes, datas e condições antes de gerar o PDF. Ao salvar, o texto customizado passa a ser usado no PDF/print.</p>
            </div>
    ...
    <div class="space-y-6">
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-6 text-sm leading-6 text-gray-600 shadow-theme-xs dark:border-gray-800 dark:bg-white/[0.03] dark:text-gray-300">
            ...
            <p class="mt-3">O sistema escolhe automaticamente o modelo ajuizado quando a OS está como cobrança judicial ou possui número de processo. Depois de revisar, salve o texto e abra o PDF/print para imprimir ou salvar como PDF pelo navegador.</p>
        </div>
    </div>
</div>
@endsection
