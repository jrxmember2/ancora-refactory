                    ...
                    @foreach($items as $item)
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4">
                                ...
                                <dialog id="view-avulso-{{ $item->id }}" class="w-full max-w-2xl rounded-3xl border border-gray-200 bg-white p-0 text-left shadow-2xl backdrop:bg-black/60 dark:border-gray-700 dark:bg-gray-900">
