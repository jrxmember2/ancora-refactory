...
Route::middleware(['ancora.auth', 'ancora.activity', 'audit.activity'])->group(function () {
    ...
    Route::get('/config/evolution-api', [ConfigController::class, 'evolution'])->name('config.evolution.index')->middleware(['ancora.superadmin', 'ancora.route:config.evolution.index']);
    Route::post('/config/evolution-api/save', [ConfigController::class, 'saveEvolution'])->name('config.evolution.save')->middleware(['ancora.superadmin', 'ancora.route:config.evolution.save']);
    ...
    Route::post('/config/demandas/categorias/store', [ConfigController::class, 'storeDemandCategory'])->name('config.demand-categories.store')->middleware(['ancora.superadmin', 'ancora.route:config.demand-categories.store']);
    Route::match(['post', 'put'], '/config/demandas/categorias/{category}', [ConfigController::class, 'updateDemandCategory'])->name('config.demand-categories.update')->middleware(['ancora.superadmin', 'ancora.route:config.demand-categories.update']);
    Route::match(['post', 'delete'], '/config/demandas/categorias/{category}/excluir', [ConfigController::class, 'deleteDemandCategory'])->name('config.demand-categories.delete')->middleware(['ancora.superadmin', 'ancora.route:config.demand-categories.delete']);
    ...
    Route::prefix('cobrancas')->group(function () {
        ...
        Route::post('/notificacoes/lote', [CobrancaController::class, 'sendCollectionNotificationBatch'])->name('cobrancas.notifications.batch')->middleware('ancora.route:cobrancas.notifications.send');
        ...
        Route::get('/tjes-avulso', [CobrancaMonetaryStandaloneController::class, 'standaloneMonetaryIndex'])->name('cobrancas.monetary.standalone.index')->middleware('ancora.route:cobrancas.monetary.standalone.index');
        Route::get('/tjes-avulso/novo', [CobrancaMonetaryStandaloneController::class, 'standaloneMonetaryCreate'])->name('cobrancas.monetary.standalone.create')->middleware('ancora.route:cobrancas.monetary.standalone.create');
        Route::post('/tjes-avulso/preview', [CobrancaMonetaryStandaloneController::class, 'standaloneMonetaryPreview'])->name('cobrancas.monetary.standalone.preview')->middleware('ancora.route:cobrancas.monetary.standalone.preview');
        Route::post('/tjes-avulso', [CobrancaMonetaryStandaloneController::class, 'standaloneMonetaryStore'])->name('cobrancas.monetary.standalone.store')->middleware('ancora.route:cobrancas.monetary.standalone.store');
        Route::get('/tjes-avulso/{memory}', [CobrancaMonetaryStandaloneController::class, 'standaloneMonetaryShow'])->name('cobrancas.monetary.standalone.show')->middleware('ancora.route:cobrancas.monetary.standalone.show');
        Route::get('/tjes-avulso/{memory}/pdf', [CobrancaMonetaryStandaloneController::class, 'standaloneMonetaryPdf'])->name('cobrancas.monetary.standalone.pdf')->middleware('ancora.route:cobrancas.monetary.standalone.pdf');
        Route::match(['post', 'delete'], '/tjes-avulso/{memory}/excluir', [CobrancaMonetaryStandaloneController::class, 'standaloneMonetaryDestroy'])->name('cobrancas.monetary.standalone.delete')->middleware('ancora.route:cobrancas.monetary.standalone.delete');
