...
Route::middleware('ancora.auth')->group(function () {
    ...
    Route::get('/dashboard', [DashboardController::class, 'index'])->name('dashboard')->middleware('ancora.route:dashboard.index');
    ...
    Route::prefix('propostas')->group(function () {
        ...
        Route::post('/{proposta}/anexos/{attachment}/delete', [ProposalController::class, 'deleteAttachment'])->name('propostas.attachments.delete')->middleware('ancora.route:propostas.attachments.delete');
        Route::get('/{proposta}/editar', [ProposalController::class, 'edit'])->name('propostas.edit')->middleware('ancora.route:propostas.edit');
        Route::post('/{proposta}/update', [ProposalController::class, 'update'])->name('propostas.update')->middleware('ancora.route:propostas.update');
        Route::post('/{proposta}/delete', [ProposalController::class, 'destroy'])->name('propostas.delete')->middleware('ancora.route:propostas.delete');
    ...
    Route::post('/config/servicos/{servico}/update', [ConfigController::class, 'updateServico'])->name('config.servicos.update')->middleware(['ancora.superadmin', 'ancora.route:config.servicos.update']);
    Route::post('/config/servicos/{servico}/delete', [ConfigController::class, 'deleteServico'])->name('config.servicos.delete')->middleware(['ancora.superadmin', 'ancora.route:config.servicos.delete']);
    ...
    Route::post('/config/status/{status}/update', [ConfigController::class, 'updateStatus'])->name('config.status.update')->middleware(['ancora.superadmin', 'ancora.route:config.status.update']);
    Route::post('/config/status/{status}/delete', [ConfigController::class, 'deleteStatus'])->name('config.status.delete')->middleware(['ancora.superadmin', 'ancora.route:config.status.delete']);
    ...
    Route::post('/config/formas-envio/{forma}/update', [ConfigController::class, 'updateFormaEnvio'])->name('config.formas.update')->middleware(['ancora.superadmin', 'ancora.route:config.formas.update']);
    Route::post('/config/formas-envio/{forma}/delete', [ConfigController::class, 'deleteFormaEnvio'])->name('config.formas.delete')->middleware(['ancora.superadmin', 'ancora.route:config.formas.delete']);
    ...
    Route::post('/config/usuarios/{user}/update', [ConfigController::class, 'updateUsuario'])->name('config.users.update')->middleware(['ancora.superadmin', 'ancora.route:config.users.update']);
    Route::post('/config/usuarios/{user}/delete', [ConfigController::class, 'deleteUsuario'])->name('config.users.delete')->middleware(['ancora.superadmin', 'ancora.route:config.users.delete']);
    ...
    Route::prefix('clientes')->group(function () {
        ...
        Route::post('/avulsos/{avulso}/update', [ClientsController::class, 'avulsoUpdate'])->name('clientes.avulsos.update')->middleware('ancora.route:clientes.avulsos.update');
        Route::post('/avulsos/{avulso}/delete', [ClientsController::class, 'avulsoDelete'])->name('clientes.avulsos.delete')->middleware('ancora.route:clientes.avulsos.delete');
        ...
        Route::post('/contatos/{contato}/update', [ClientsController::class, 'contatoUpdate'])->name('clientes.contatos.update')->middleware('ancora.route:clientes.contatos.update');
        Route::post('/contatos/{contato}/delete', [ClientsController::class, 'contatoDelete'])->name('clientes.contatos.delete')->middleware('ancora.route:clientes.contatos.delete');
        ...
        Route::post('/condominios/{condominio}/update', [ClientsController::class, 'condominioUpdate'])->name('clientes.condominios.update')->middleware('ancora.route:clientes.condominios.update');
        Route::post('/condominios/{condominio}/delete', [ClientsController::class, 'condominioDelete'])->name('clientes.condominios.delete')->middleware('ancora.route:clientes.condominios.delete');
        ...
        Route::post('/unidades/{unidade}/update', [ClientsController::class, 'unidadeUpdate'])->name('clientes.unidades.update')->middleware('ancora.route:clientes.unidades.update');
        Route::post('/unidades/{unidade}/delete', [ClientsController::class, 'unidadeDelete'])->name('clientes.unidades.delete')->middleware('ancora.route:clientes.unidades.delete');
        ...
        Route::post('/anexos/{attachment}/delete', [ClientsController::class, 'attachmentDelete'])->name('clientes.attachments.delete')->middleware('ancora.route:clientes.attachments.delete');
    });
