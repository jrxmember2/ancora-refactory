...
Route::middleware(['ancora.auth', 'ancora.activity', 'audit.activity'])->group(function () {
    ...
    Route::prefix('cobrancas')->group(function () {
        ...
        Route::get('/tjes-avulso', [CobrancaController::class, 'standaloneMonetaryIndex'])->name('cobrancas.monetary.standalone.index')->middleware('ancora.route:cobrancas.monetary.standalone.index');
        Route::get('/tjes-avulso/novo', [CobrancaController::class, 'standaloneMonetaryCreate'])->name('cobrancas.monetary.standalone.create')->middleware('ancora.route:cobrancas.monetary.standalone.create');
        Route::post('/tjes-avulso/preview', [CobrancaController::class, 'standaloneMonetaryPreview'])->name('cobrancas.monetary.standalone.preview')->middleware('ancora.route:cobrancas.monetary.standalone.preview');
        Route::post('/tjes-avulso', [CobrancaController::class, 'standaloneMonetaryStore'])->name('cobrancas.monetary.standalone.store')->middleware('ancora.route:cobrancas.monetary.standalone.store');
        Route::get('/tjes-avulso/{memory}', [CobrancaController::class, 'standaloneMonetaryShow'])->name('cobrancas.monetary.standalone.show')->middleware('ancora.route:cobrancas.monetary.standalone.show');
        Route::get('/tjes-avulso/{memory}/pdf', [CobrancaController::class, 'standaloneMonetaryPdf'])->name('cobrancas.monetary.standalone.pdf')->middleware('ancora.route:cobrancas.monetary.standalone.pdf');
        Route::match(['post', 'delete'], '/tjes-avulso/{memory}/excluir', [CobrancaController::class, 'standaloneMonetaryDestroy'])->name('cobrancas.monetary.standalone.delete')->middleware('ancora.route:cobrancas.monetary.standalone.delete');
