...
class AuditLogPresenter
{
    public static function actionLabel(?string $action): string
    {
        ...
        $labels = [
            ...
            'config.demand-categories.store' => 'Criou categoria de demanda',
            'config.demand-categories.update' => 'Atualizou categoria de demanda',
            'config.demand-categories.delete' => 'Excluiu categoria de demanda',
