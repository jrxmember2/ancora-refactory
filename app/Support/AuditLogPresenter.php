...
class AuditLogPresenter
{
    public static function actionLabel(?string $action): string
    {
        ...
        $labels = [
            ...
            'assinador.dashboard' => 'Acessou dashboard do Assinador Eletronico',
            'assinador.index' => 'Listou assinaturas eletronicas',
            'assinador.create' => 'Abriu nova assinatura avulsa',
            'assinador.store' => 'Enviou documento avulso para assinatura',
            'assinador.show' => 'Visualizou assinatura avulsa',
            'assinador.signatures.sync' => 'Sincronizou assinatura avulsa',
            'assinador.signatures.download' => 'Baixou artefato da assinatura avulsa',
            ...
            'config.ai.index' => 'Abriu configuracoes de Inteligencia Artificial',
            'config.ai.save' => 'Atualizou configuracoes de Inteligencia Artificial',
            'config.ai.test' => 'Testou conexao da Inteligencia Artificial',
            'config.ai.legal-base.index' => 'Abriu Base Legal Global da Inteligencia Artificial',
            'config.ai.legal-base.store' => 'Cadastrou documento na Base Legal Global',
            'config.ai.legal-base.update' => 'Atualizou documento da Base Legal Global',
            'config.ai.legal-base.process' => 'Processou documento da Base Legal Global',
            'config.ai.legal-base.download' => 'Baixou documento da Base Legal Global',
            'config.ai.chat-history.index' => 'Abriu Historico de Consultas da Inteligencia Artificial',
            'config.ai.chat-history.show' => 'Visualizou detalhe de consulta da Inteligencia Artificial',
            'config.ai.chat-history.update' => 'Atualizou marcacoes de consulta da Inteligencia Artificial',
            'ia.office-chat.index' => 'Abriu Leme Escritorio',
            'ia.office-chat.ask' => 'Enviou pergunta no Leme Escritorio',
            'ia.office-chat.show' => 'Abriu conversa do Leme Escritorio',
            'ia.office-chat.delete' => 'Excluiu conversa do Leme Escritorio',
            ...
            'config.demand-categories.store' => 'Criou servico compartilhado de demandas e propostas',
            'config.demand-categories.update' => 'Atualizou servico compartilhado de demandas e propostas',
            'config.demand-categories.delete' => 'Excluiu servico compartilhado de demandas e propostas',
            ...
            'financeiro.payables.attachments.upload' => 'Anexou arquivo em conta a pagar',
            'financeiro.payables.attachments.delete' => 'Excluiu anexo de conta a pagar',
            ...
            'financeiro.receivables.duplicate' => 'Duplicou conta a receber',
            'financeiro.receivables.renegotiate' => 'Renegociou conta a receber',
            'financeiro.receivables.attachments.upload' => 'Anexou arquivo em conta a receber',
            'financeiro.receivables.attachments.delete' => 'Excluiu anexo de conta a receber',
            'financeiro.cash-flow.store' => 'Registrou movimentacao no fluxo de caixa',
            'financeiro.reimbursements.store' => 'Criou reembolso',
            'financeiro.reimbursements.update' => 'Atualizou reembolso',
            'financeiro.reimbursements.delete' => 'Excluiu reembolso',
            'financeiro.process-costs.store' => 'Criou custa processual',
            'financeiro.process-costs.update' => 'Atualizou custa processual',
            'financeiro.process-costs.delete' => 'Excluiu custa processual',
            'financeiro.accounts.store' => 'Criou conta financeira',
            'financeiro.accounts.update' => 'Atualizou conta financeira',
            'financeiro.accounts.delete' => 'Excluiu conta financeira',
            'financeiro.cost-centers.store' => 'Criou centro de custo',
            'financeiro.cost-centers.update' => 'Atualizou centro de custo',
            'financeiro.cost-centers.delete' => 'Excluiu centro de custo',
            'financeiro.categories.store' => 'Criou categoria financeira',
            'financeiro.categories.update' => 'Atualizou categoria financeira',
            'financeiro.categories.delete' => 'Excluiu categoria financeira',
            'financeiro.installments.store' => 'Gerou parcelamento',
            'financeiro.installments.delete' => 'Excluiu parcela',
            'financeiro.reconciliation.conciliate' => 'Conciliou lancamento bancario',
            'financeiro.billing.generate-contract' => 'Gerou faturamento de contrato',
            'financeiro.settings.save' => 'Atualizou configuracoes financeiras',
    ...
    public static function moduleLabel(?string $entityType): string
    {
        ...
        $labels = [
            ...
            'electronic_signature_documents' => 'Assinador Eletronico',
            'propostas' => 'Propostas',
            'users' => 'Usuários',
            'ai_global_documents' => 'Base Legal Global',
            'ai_chat_conversations' => 'Conversas da Leme',
            'ai_chat_messages' => 'Historico de Consultas IA',
            'ai_chat_message_sources' => 'Fontes das Consultas IA',
            'ai_office_chat_conversations' => 'Conversas do Leme Escritorio',
            'ai_office_chat_messages' => 'Mensagens do Leme Escritorio',
            ...
            'financial_reimbursements' => 'Reembolsos',
            'financial_process_costs' => 'Custas processuais',
            'financial_accounts' => 'Bancos e contas',
            'financial_cost_centers' => 'Centros de custo',
            'financial_categories' => 'Categorias financeiras',
            'financial_installments' => 'Parcelamentos',
            'financial_statements' => 'Conciliacao bancaria',
        ];
    ...
    public static function entityTypeForRoute(string $routeName, ?string $fallback = null): ?string
    {
        return match (true) {
            ...
            Str::startsWith($routeName, 'financeiro.cash-flow') => 'financial_transactions',
            Str::startsWith($routeName, 'financeiro.reimbursements') => 'financial_reimbursements',
            Str::startsWith($routeName, 'financeiro.process-costs') => 'financial_process_costs',
            Str::startsWith($routeName, 'financeiro.accounts') => 'financial_accounts',
            Str::startsWith($routeName, 'financeiro.cost-centers') => 'financial_cost_centers',
            Str::startsWith($routeName, 'financeiro.categories') => 'financial_categories',
            Str::startsWith($routeName, 'financeiro.installments') => 'financial_installments',
            Str::startsWith($routeName, 'financeiro.reconciliation') => 'financial_statements',
            ...
            Str::startsWith($routeName, 'config.ai.legal-base') => 'ai_global_documents',
    ...
    private static function recordLabelFromRequest(Request $request, string $routeName): string
    {
        ...
        return match (true) {
            ...
            Str::startsWith($routeName, 'ia.office-chat') => self::namedRecord('CONVERSA DO LEME ESCRITORIO', self::inputOrRouteValue($request, ['question'], ['conversation'], ['title'])),
            Str::startsWith($routeName, 'config.ai.chat-history') => self::namedRecord('CONSULTA DE IA', self::inputOrRouteValue($request, [], ['message'], ['id'])),
            Str::startsWith($routeName, 'config.ai.legal-base') => self::namedRecord('DOCUMENTO GLOBAL DE IA', self::inputOrRouteValue($request, ['name'], ['document'], ['name'])),
            ...
            Str::startsWith($routeName, 'config.demand-categories') => self::namedRecord('CATEGORIA DE DEMANDA', self::inputOrRouteValue($request, ['name'], ['category'], ['name'])),
    ...
    private static function genericRecordFromAction(string $action): string
    {
        ...
        return match (true) {
            ...
            Str::startsWith($action, 'ia.office-chat') => 'CONVERSA DO LEME ESCRITORIO',
            Str::startsWith($action, 'config.ai.chat-history') => 'CONSULTA DE IA',
            Str::startsWith($action, 'config.ai.legal-base') => 'DOCUMENTO GLOBAL DE IA',
            Str::startsWith($action, 'config.tjes-factors') => 'INDICE TJES',
            Str::startsWith($action, 'config.demand-tags') => 'TAG DE DEMANDA',
            Str::startsWith($action, 'config.demand-categories') => 'CATEGORIA DE DEMANDA',
