...
class ContractVariableCatalog
{
    public static function definitions(): array
    {
        return [
            ...
            ['key' => 'sindico_nome', 'label' => 'Sindico - nome/qualificacao', 'description' => 'Nome do sindico ou qualificacao completa quando for PJ.', 'source' => 'client_entities.display_name'],
            ['key' => 'sindico_nome_simples', 'label' => 'Sindico - nome simples', 'description' => 'Nome simples do sindico ou da empresa.', 'source' => 'client_entities.display_name'],
            ['key' => 'sindico_cpf', 'label' => 'Sindico - documento', 'description' => 'CPF ou CNPJ do sindico informado.', 'source' => 'client_entities.cpf_cnpj'],
            ['key' => 'sindico_documento', 'label' => 'Sindico - documento', 'description' => 'CPF ou CNPJ do sindico informado.', 'source' => 'client_entities.cpf_cnpj'],
            ['key' => 'sindico_qualificacao', 'label' => 'Sindico - qualificacao completa', 'description' => 'Texto com empresa/CNPJ e representante PF, quando aplicavel.', 'source' => 'client_entities.shareholders_json'],
            ['key' => 'sindico_representante_nome', 'label' => 'Sindico - representante PF', 'description' => 'Nome da pessoa fisica representante da PJ.', 'source' => 'client_entities.shareholders_json'],
            ['key' => 'sindico_representante_documento', 'label' => 'Sindico - documento do representante', 'description' => 'CPF do representante da pessoa juridica.', 'source' => 'client_entities.shareholders_json'],
