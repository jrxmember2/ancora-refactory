...
class ContractVariableCatalog
{
    public static function definitions(): array
    {
        return [
            ...
            ['key' => 'sindico_nome', 'label' => 'Sindico - nome/qualificacao', 'description' => 'Nome do sindico. Se for PJ, pode incluir automaticamente a qualificacao da empresa e do representante.', 'source' => 'client_entities.display_name'],
            ['key' => 'sindico_nome_simples', 'label' => 'Sindico - nome simples', 'description' => 'Nome simples do sindico ou da empresa sindica, sem qualificacao expandida.', 'source' => 'client_entities.display_name'],
            ['key' => 'sindico_cpf', 'label' => 'Sindico - documento', 'description' => 'Documento principal do sindico vinculado (CPF ou CNPJ).', 'source' => 'client_entities.cpf_cnpj'],
            ['key' => 'sindico_documento', 'label' => 'Sindico - documento generico', 'description' => 'Documento principal do sindico vinculado (CPF ou CNPJ).', 'source' => 'client_entities.cpf_cnpj'],
            ['key' => 'sindico_qualificacao', 'label' => 'Sindico - qualificacao completa', 'description' => 'Texto pronto com qualificacao do sindico. Se for PJ, traz empresa, CNPJ e representante PF quando houver.', 'source' => 'client_entities.shareholders_json'],
            ['key' => 'sindico_representante_nome', 'label' => 'Sindico - representante PF', 'description' => 'Nome do representante pessoa fisica do sindico PJ, quando cadastrado.', 'source' => 'client_entities.shareholders_json'],
            ['key' => 'sindico_representante_documento', 'label' => 'Sindico - documento do representante', 'description' => 'CPF do representante pessoa fisica do sindico PJ, quando cadastrado.', 'source' => 'client_entities.shareholders_json'],
