        ...
        return [
            ...
            'config' => [
                ...
                'routes' => [
                    ...
                    'config.evolution.index' => 'Acessar configuracoes da EvolutionAPI',
                    'config.evolution.save' => 'Salvar configuracoes da EvolutionAPI',
                    'config.evolution.test' => 'Testar conexao da EvolutionAPI',
                    'config.evolution.webhook.sync' => 'Sincronizar webhook da EvolutionAPI',
                    'config.evolution.message.test' => 'Enviar mensagem de teste pela EvolutionAPI',
                    'config.ai.legal-base.index' => 'Acessar Base Legal Global da Inteligencia Artificial',
                    'config.ai.legal-base.store' => 'Cadastrar documento na Base Legal Global',
                    'config.ai.legal-base.update' => 'Editar documento da Base Legal Global',
                    'config.ai.legal-base.process' => 'Processar documento da Base Legal Global',
                    'config.ai.legal-base.download' => 'Baixar documento da Base Legal Global',
                    'config.ai.chat-history.index' => 'Acessar Historico de Consultas da Inteligencia Artificial',
                    'config.ai.chat-history.show' => 'Visualizar detalhe de consulta da Inteligencia Artificial',
                    'config.ai.chat-history.update' => 'Atualizar marcacoes do Historico de Consultas da Inteligencia Artificial',
                    'config.push.index' => 'Acessar disparo administrativo de push mobile',
                    'config.push.users' => 'Listar usuarios elegiveis para disparo de push mobile',
                    'config.push.send' => 'Enviar disparo administrativo de push mobile',
                    'config.push.show' => 'Acompanhar status de disparo administrativo de push mobile',
                    ...
                    'config.demand-categories.store' => 'Cadastrar servico compartilhado de demandas e propostas',
                    'config.demand-categories.update' => 'Editar servico compartilhado de demandas e propostas',
                    'config.demand-categories.delete' => 'Excluir servico compartilhado de demandas e propostas',
                    'config.servicos.store' => 'Gerenciar servico legado de propostas',
                    'config.servicos.update' => 'Gerenciar servico legado de propostas',
                    'config.servicos.delete' => 'Gerenciar servico legado de propostas',
            ...
            'cobrancas' => [
                ...
                'routes' => [
                    ...
                    'cobrancas.monetary.standalone.index' => 'Listar memorias de calculo TJES avulsas',
                    'cobrancas.monetary.standalone.create' => 'Abrir novo calculo TJES avulso',
                    'cobrancas.monetary.standalone.preview' => 'Simular atualizacao monetaria TJES avulsa',
                    'cobrancas.monetary.standalone.store' => 'Salvar memoria de calculo TJES avulsa',
                    'cobrancas.monetary.standalone.show' => 'Visualizar memoria de calculo TJES avulsa',
                    'cobrancas.monetary.standalone.pdf' => 'Gerar PDF da memoria de calculo TJES avulsa',
                    'cobrancas.monetary.standalone.delete' => 'Excluir memoria de calculo TJES avulsa',
