...
class ConfigController extends Controller
{
    public function index(): View
    {
        ...
        return view('pages.admin.config', [
            ...
            'branding' => [
                ...
                'company_phone_is_whatsapp' => AppSetting::getValue('company_phone_is_whatsapp', '0') === '1',
                'company_social_instagram' => AppSetting::getValue('company_social_instagram', '') ?: '',
                'company_social_linkedin' => AppSetting::getValue('company_social_linkedin', '') ?: '',
                'company_social_youtube' => AppSetting::getValue('company_social_youtube', '') ?: '',
                'company_social_facebook' => AppSetting::getValue('company_social_facebook', '') ?: '',
                'company_social_whatsapp_channel' => AppSetting::getValue('company_social_whatsapp_channel', '') ?: '',
                'company_social_tiktok' => AppSetting::getValue('company_social_tiktok', '') ?: '',
                'company_social_linktree' => AppSetting::getValue('company_social_linktree', '') ?: '',
    ...
    public function saveBranding(Request $request): RedirectResponse
    {
        $validated = $request->validate([
            ...
            'company_phone_is_whatsapp' => ['nullable', 'boolean'],
            'company_social_instagram' => ['nullable', 'string', 'max:190'],
            'company_social_linkedin' => ['nullable', 'string', 'max:190'],
            'company_social_youtube' => ['nullable', 'string', 'max:190'],
            'company_social_facebook' => ['nullable', 'string', 'max:190'],
            'company_social_whatsapp_channel' => ['nullable', 'string', 'max:190'],
            'company_social_tiktok' => ['nullable', 'string', 'max:190'],
            'company_social_linktree' => ['nullable', 'string', 'max:190'],
        ...
        $this->setMany([
            ...
            'company_phone_is_whatsapp' => [$request->boolean('company_phone_is_whatsapp') ? '1' : '0', 'Define se o telefone principal usa ícone de WhatsApp no PDF'],
            'company_social_instagram' => [$validated['company_social_instagram'] ?? '', 'Instagram exibido no PDF'],
            'company_social_linkedin' => [$validated['company_social_linkedin'] ?? '', 'LinkedIn exibido no PDF'],
            'company_social_youtube' => [$validated['company_social_youtube'] ?? '', 'YouTube exibido no PDF'],
            'company_social_facebook' => [$validated['company_social_facebook'] ?? '', 'Facebook exibido no PDF'],
            'company_social_whatsapp_channel' => [$validated['company_social_whatsapp_channel'] ?? '', 'Canal do WhatsApp exibido no PDF'],
            'company_social_tiktok' => [$validated['company_social_tiktok'] ?? '', 'TikTok exibido no PDF'],
            'company_social_linktree' => [$validated['company_social_linktree'] ?? '', 'Linktree exibido no PDF'],
